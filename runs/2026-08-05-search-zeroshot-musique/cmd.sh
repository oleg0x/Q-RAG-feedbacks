#!/usr/bin/env bash
# Ран 2026-08-05-search-zeroshot-musique, собран exp.py из configs/search_zeroshot_musique.yaml.
...
python exp.py run --config configs/search_zeroshot_musique.yaml --only score
