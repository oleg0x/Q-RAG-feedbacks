#!/usr/bin/env bash
# Ран 2026-08-02-gte-pool-diag, собран exp.py из configs/gte_pool_diag.yaml.
...
python exp.py run --config configs/gte_pool_diag.yaml --only score
