#!/usr/bin/env bash
# Ран 2026-08-10-sr1-rawmix8b-best-bamboogle, собран exp.py из configs/sr1_rawmix8b-best_bamboogle.yaml.
...
python exp.py run --config configs/sr1_rawmix8b-best_bamboogle.yaml --only score
