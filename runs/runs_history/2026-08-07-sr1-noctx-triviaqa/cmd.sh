#!/usr/bin/env bash
# Ран 2026-08-07-sr1-noctx-triviaqa, собран exp.py из configs/sr1_triviaqa_noctx.yaml.
...
HF_HUB_OFFLINE=1 TRANSFORMERS_OFFLINE=1 \
  /home/a.anokhin/venvs/gpu/bin/python build_eval_variants.py --context none --input /home/a.anokhin/Judge/full-wiki/runs/2026-08-07-sr1-best-triviaqa/retrieval.jsonl --output /home/a.anokhin/Judge/full-wiki/runs/2026-08-07-sr1-noctx-triviaqa/retrieval.jsonl
...
python exp.py run --config configs/sr1_triviaqa_noctx.yaml --only score
