#!/usr/bin/env bash
# Ран 2026-08-02-gte-refresh-q1024-steps6, собран exp.py из configs/gte_refresh_q1024_steps6.yaml.
...
python exp.py run --config configs/gte_refresh_q1024_steps6.yaml --only score
