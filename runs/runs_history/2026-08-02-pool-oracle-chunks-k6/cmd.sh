#!/usr/bin/env bash
# Ран 2026-08-02-pool-oracle-chunks-k6, собран exp.py из configs/pool_oracle_chunks_k6.yaml.
...
python exp.py run --config configs/pool_oracle_chunks_k6.yaml --only score
