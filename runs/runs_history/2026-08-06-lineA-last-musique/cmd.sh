#!/usr/bin/env bash
# Ран 2026-08-06-lineA-last-musique, собран exp.py из configs/search_last_musique.yaml.
...
CUDA_VISIBLE_DEVICES=2 HF_HUB_OFFLINE=1 TRANSFORMERS_OFFLINE=1 \
  /home/a.anokhin/venvs/gpu/bin/python fullwiki_qrag.py search --index-dir /home/a.anokhin/Judge/datasets/data_sources/full-wiki/wiki18-gte --qrag-repo /home/a.anokhin/Judge/full-wiki/Q-RAG_for_full-wiki --device cuda:0 --model-dtype float32 --input /home/a.anokhin/Judge/full-wiki/runs/shared/musique_ans_dev_hotpot_schema.jsonl --output /home/a.anokhin/Judge/full-wiki/runs/2026-08-06-lineA-last-musique/retrieval.jsonl --batch-size 64 --top-k 100 --steps 6 --max-chunks-per-title 2 --log-candidates full --checkpoint /home/a.anokhin/Judge/full-wiki/Q-RAG_for_full-wiki/runs/Aug03_12-44-38_lineA_main/model_last.pt --state-source critic --no-auto-prepare
...
python exp.py run --config configs/search_last_musique.yaml --only score
