#!/usr/bin/env bash
# Ран 2026-08-02-gte-pool-diag-k500, собран exp.py из configs/gte_pool_diag_k500.yaml.
...
python exp.py run --config configs/gte_pool_diag_k500.yaml --only score
