#!/usr/bin/env bash
# Ран 2026-08-02-gte-refresh-q1024-steps4, собран exp.py из configs/gte_refresh_q1024_steps4.yaml.
...
python exp.py run --config configs/gte_refresh_q1024_steps4.yaml --only score
