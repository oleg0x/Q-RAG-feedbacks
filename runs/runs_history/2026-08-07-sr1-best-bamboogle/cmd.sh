#!/usr/bin/env bash
# Ран 2026-08-07-sr1-best-bamboogle, собран exp.py из configs/sr1_bamboogle_best.yaml.
...
python exp.py run --config configs/sr1_bamboogle_best.yaml --only score
