#!/usr/bin/env bash
# Ран 2026-08-02-pool-oracle-titles-k4, собран exp.py из configs/pool_oracle_titles_k4.yaml.
...
python exp.py run --config configs/pool_oracle_titles_k4.yaml --only score
