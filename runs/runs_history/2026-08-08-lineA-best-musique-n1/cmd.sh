#!/usr/bin/env bash
# Ран 2026-08-08-lineA-best-musique-n1, собран exp.py из configs/search_best_musique_n1.yaml.
...
python exp.py run --config configs/search_best_musique_n1.yaml --only score
