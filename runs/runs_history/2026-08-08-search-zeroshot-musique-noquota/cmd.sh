#!/usr/bin/env bash
# Ран 2026-08-08-search-zeroshot-musique-noquota, собран exp.py из configs/search_zeroshot_musique_noquota.yaml.
...
python exp.py run --config configs/search_zeroshot_musique_noquota.yaml --only score
