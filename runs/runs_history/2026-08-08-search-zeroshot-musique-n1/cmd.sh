#!/usr/bin/env bash
# Ран 2026-08-08-search-zeroshot-musique-n1, собран exp.py из configs/search_zeroshot_musique_n1.yaml.
...
python exp.py run --config configs/search_zeroshot_musique_n1.yaml --only score
