#!/usr/bin/env bash
# Ран 2026-08-02-pool-oracle-chunks-n2-k2, собран exp.py из configs/pool_oracle_chunks_n2_k2.yaml.
...
python exp.py run --config configs/pool_oracle_chunks_n2_k2.yaml --only score
