#!/usr/bin/env bash
# Ран 2026-08-02-gte-only-n2-steps6, собран exp.py из configs/gte_only_n2_steps6.yaml.
...
python exp.py run --config configs/gte_only_n2_steps6.yaml --only score
