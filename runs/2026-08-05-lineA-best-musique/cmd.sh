#!/usr/bin/env bash
# Ран 2026-08-05-lineA-best-musique, собран exp.py из configs/search_best_musique.yaml.
...
python exp.py run --config configs/search_best_musique.yaml --only score
