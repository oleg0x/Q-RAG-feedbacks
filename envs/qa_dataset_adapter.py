...
import envs.dataloaders.hellaswag as hellaswag
import envs.dataloaders.mmlupro as mmlupro
...
class QADatasetAdapter(Dataset):
    ...
    def __getitem__(self, index):
        ...
        if source in {'hotpotqa', '2WikiMultihopQA'}:   # They have the same format
            ...
            sf_idx = [0]  #sf_idx = None
            #print("Chunks count:", len(chunk_texts))
