...
sys_qa_occ = """You are a precise question answering assistant. Keep your reasoning brief. """
...
sys_ssig = """You are a precise question answering assistant used to estimate information gain.
Answer questions based ONLY on the relevant information within the provided context and ignore misleading text.
Make your final answer as short as possible.
Give me your short and precise final answer
"""

sys_sep = """You are a precise question answering assistant.
Answer questions based ONLY on the relevant information within the provided context and ignore misleading text.
Make your final answer as short as possible.
Give me your short and precise final answer
"""
